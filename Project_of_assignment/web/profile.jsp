...
<html>
    <head>
        ...
        <div class="container p-5 bg-secondary-subtle rounded shadow">
            <div class="p-2 text-center"><h1 class="text-uppercase">Profile</h1></div>
            <form action="profile" method="post" enctype="multipart/form-data">
                <div class="row position-relative">
                    <div class="col-4">
                        <c:if test="${sessionScope.hehe!= null}">
                            <div class="input-group">
                                ...
                                <label for="inputGroupFile04"><img src="assets/img/accounts/${sessionScope.account.getImage()}" id="image" class="img-thumbnail rounded-5" width="100%" alt="${sessionScope.account.getImage()}"></label>
                            </div>
                        </c:if>
                        <c:if test="${sessionScope.hehe == null}">
                            <div class="input-group">
                                <input type="file" name="img" class="form-control d-none" id="inputGroupFile04" onchange="chooseFile(this)" accept="image/gif,image/jpeg,image/png" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                <label for="inputGroupFile04"><img src="assets/img/1.png" id="image" class="img-thumbnail rounded-5" width="100%" alt="1.png"></label>
                            </div>
                        </c:if>
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3" >
                            ...
                            <input type="text" name="username" value="${sessionScope.account.getUsername()}" class="form-control form-control-lg fs-6 " readonly="" placeholder="Username">
                        </div>
                        ...
                        <div class="row">
                            <div class=" col">
                                ...
                                <div class="input-group mb-3" >
                                    ...
                                    <input type="text" name="firstname" value="${sessionScope.account.getFirstname()}" class="form-control form-control-lg fs-6" placeholder="First name">
                                </div>
                            </div>
                            <div class="col">
                                <p>Last name</p>
                                ...
                                <div class="input-group mb-3" >
                                    ...
                                    <input type="text" name="lastname" value="${sessionScope.account.getLastname()}" class="form-control form-control-lg fs-6" placeholder="Last Name">
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5 text-uppercase" id="exampleModalLabel">change password</h1>
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group mb-3" >
                                            ...
                                            <input type="password" name="OLDP" class="form-control form-control-lg fs-6" placeholder="Your password">
                                        </div>
                                        <hr>
                                        <div class="input-group mb-3" >
                                            <span class="input-group-text">
                                            ...
                                            <input type="password" name="NP" class="form-control form-control-lg fs-6" placeholder="New password">
                                        </div>
                                        <div class="input-group mb-3" >
                                            <span class="input-group-text">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
                                            ...
                                            <input type="password" name="CP" class="form-control form-control-lg fs-6" placeholder="Confirm new password">
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="btn" value="cp" class="btn btn-primary">Save</button>
                                    </div>
                        ...
                        <div>
                            <button class="btn btn-dark position-absolute bottom-0 end-0" name="btn" type="submit"  value="all" id="inputGroupFileAddon04">SAVE</button>
                        </div>
                    </div>
                </div>
            </form>
