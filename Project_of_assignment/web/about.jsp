<%-- 
    Document   : about
    Created on : Mar 5, 2024, 3:56:50 PM
    Author     : nguye
--%>
...
<html>
    <head>
        ...
        <jsp:useBean id="pc" class="dal.Product_CategoryDAO" scope="request"></jsp:useBean>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-center align-items-center flex-grow-1 pe-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active mx-lg-2" href="#">About</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class=" pt-5 pb-5 container bg-body-secondary rounded shadow-lg">
            <h1 class="text-uppercase d-flex justify-content-center">About me</h1>
            <div class="p-5" style="text-align: justify ">
                Chúng tôi tự hào là một trong những trang web hàng đầu về trang sức trực tuyến. Phương châm của chúng tôi là “Cuộc sống phải rực rỡ, quyến rũ“. Hãy tận hưởng nó, bạn chính là người đẹp nhất!
                <b class="fw-semibold">Store by Heart</b> được thành lập với sứ mệnh mang lại phong cách và đẳng cấp cho cuộc sống của bạn bởi những món trang sức tuyệt đẹp. Chúng tôi tin rằng trang sức không chỉ là phụ kiện mà còn là một cách để bạn thể hiện bản thân, kể những câu chuyện, gửi gắm hy vọng, lời chúc ý nghĩa đến người thân, bạn bè, đồng nghiệp mà mình yêu mến. <b class="fw-semibold">Store by Heart</b> luôn nắm bắt tốt “thời trang” và “sự độc đáo“ trong nhiều dịp lễ, ngày kỹ niệm khác nhau. Chính vì vậy chúng tôi tự tin là nơi bạn có thể chọn lựa được những món trang sức làm nổi bật cá tính và phong cách riêng của bạn.

            </div>
            <div class="d-flex justify-content-center">            
                <img class="" src="assets/img/M.png" alt="M.png">
            </div>
            <div class="p-5" style="text-align: justify ">
                Tại <b class="fw-semibold">Store Heart</b> bạn sẽ tìm thấy: 
                <c:forEach var="i" items="${pc.all}">
                    <a  href="/Project_of_assignment/listP?pc=${i.id}&&index=1" class="fw-semibold text-uppercase ${i.id == pcc.id ? "text-bg-secondary":""}">${i.name}</a>
                </c:forEach><br/>
                Trang sức cao cấp<br/>
                Chúng tôi cung cấp các loại trang sức từ vàng, bạc, đá quý, ngọc trai và nhiều loại chất liệu khác. Từ phong cách trang sức đơn giản đến những thiết kế phức tạp bạn có thể dễ dàng tìm thấy món trang sức phù hợp với sở thích, cá tính, phong cách riêng và vào từng sự kiện để bạn tư tin toả sáng.
                <br/>

                Sáng tạo thỏa thích:<br/>
                Chúng tôi hiểu rằng bạn luôn muốn có một món trang sức độc đáo riêng biệt cho bản thân, có những khoảnh khắc đặc biệt trong cuộc sống mà bạn muốn kỷ niệm. Với dịch vụ trang sức tuỳ chỉnh này bạn có thể tham gia vào quá trình thiết kế riêng trang sức mang ý nghĩa và độc đáo dành riêng cho bạn hoặc quà tặng cho người thân yêu
                <br/>
                Trang Sức Chất Lượng Cao:<br/>
                Đối với những người yêu thích sự sang trọng và đẳng cấp, chúng tôi cung cấp một bộ sưu tập trang sức chất lượng cao được sản xuất từ ​​những nguyên liệu tốt nhất. Những chi tiết tỉ mỉ và thiết kế độc đáo làm nổi bật đẳng cấp của bạn
                <br/>
                Sự Đa Dạng Phong Cách:<br/>
                Chúng tôi hiểu rằng mỗi khách hàng có một sở thích, phong cách thời trang riêng. Nên chúng tôi luôn cập nhật các mẫu trang sức từ cổ điển, vintage cho đến trang sức hiện đại và thời trang đường phố. Dù bạn là người yêu thích trang sức truyền thống hay bạn luôn tìm kiếm những phong cách trang sức độc đáo, chúng tôi đều có những gì dành riêng cho bạn
            </div>
        </div>

        <!-- footer -->
        <div class=" pt-5 container-fluid" id="contact">
            <div class="row">
