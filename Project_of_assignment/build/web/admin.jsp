<%-- 
    Document   : payment
    Created on : Mar 11, 2024, 7:23:32 AM
    Author     : nguye
--%>
...
<html>
    <head>
        ...
        <jsp:useBean id="a" class="controller.admin" scope="request"></jsp:useBean>
            ...
            <div class="col-2">
                <div class="pt-5">
                    <div class="list-group text-uppercase shadow rounded-2">
                        <a class="p-3 m-0 fw-semibold text-bg-dark rounded btn" href="#">Admin</a>
                        <div class="d-flex justify-content-between p-3">
                        </div>
                        <c:set var="check" value="${check}"/>
                        <c:forEach var="i" items="${a.first}">
                            <a  href="/Project_of_assignment/admin?admin=${i}&&index=1" class="list-group-item list-group-item-action px-3 fw-semibold ${i == check ? "text-bg-secondary":""}">${i}</a>
                        </c:forEach>
                    </div>
                </div>
                ...
                <div class=" rounded container bg-secondary-subtle">
                    <div class="p-5">
                        ...
                        <div class="row  d-flex justify-content-center" >
                            ...
                            <c:if test="${sts!=null}">
                                <c:forEach var="i" items="${sts}" >
                                    <div class="col-4 d-flex justify-content-between bg-light-subtle m-2 shadow rounded">
                                        <div class="text-uppercase">
                                            <h2>${i.fir}</h2>
                                        </div>
                                        <div class="">
                                            <h2 class="text-warning">${i.sec}</h2>
                                        </div>
                                    </div>
                                </c:forEach>
                            </c:if>
                            <c:if test="${acc!=null}">
                                ...
                                <table class="w-100 text-center table table-hover">
                                    <tr class="table-dark bg-black">
                                        <td>IMAGE</td>
                                        <td>ID</td>
                                        <td>USER NAME</td>
                                        <td>PASSWORD</td>
                                    ...
                                    <c:forEach var="i" items="${acc}" >
                                        <tr>
                                            ...
                                            <td class="z-1"><img herf="assets/img/1.png" class="img-thumbnail" width="50" height="50"> </td>
                                            <td>${i.id}</td>
                                            <td>${i.username}</td>
                                            <td>${i.password}</td>
                                            <td>${i.firstname}</td>
                            ...
                            <c:if test="${pro!=null}">
                                ...
                                <table class="w-100 text-center  table table-hover">
                                    <tr class="table-dark bg-black">
                                        ...
                                        <td>ID</td>
                                        <td>NAME</td>
                                        <td class="text-uppercase">descriotion</td>
                                        <td>PRICE</td>
                                        <td>QUANTITY</td>
                                        <td></td>
                                    </tr>
                                    <c:forEach var="i" items="${pro}" >
                                        <tr>
                                            ...
                                            <td class=""><img herf="assets/img/products/${i.image}" class="img-thumbnail" width="50" height="50"> </td>
                                            <td>${i.id}</td>
                                            <td>${i.name}</td>
                                            <td>${i.descriotion}</td>
                                            <td>${i.price}</td>
