...
<html>
    <head>
        ...
        <c:set var="cart" value="${sessionScope.SPC}" scope="request"/>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" style="width: 500px">
                                                    ...
                                                    <li>
                                                        <div style="height: 100px" class="d-flex position-relative justify-content-between p-1">
                                                            <img src="assets/img/products/P11.png" class="flex-shrink-0 me-3" alt="${y.image}">
                                        ...
                                        <li class="d-flex text-center justify-content-center"><a href="/Project_of_assignment/Pay"> <button type="button" class="btn p-2 w-75 btn-dark" >Payment</button></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-4">
                <div class="pt-5">
                    <div class="list-group text-uppercase shadow rounded-2">
                        <a class="p-3 m-0 fw-semibold text-bg-dark rounded btn" href="#">Payment</a>
                        ...
                        <div class="d-flex justify-content-between p-3">
                            ...
                            <div id="total" class="w-75">
                                <input type="text" class="w-100">
                            </div>
                        </div>
                        <div class="d-flex justify-content-center w-100 p-3">
                            <img src="assets/img/qr.jpg"  class="img-thumbnail w-50">
                        </div>
                        <div class="d-flex justify-content-center w-100 p-3">
                            <form action="listP" method="get" class="w-100">
                                <button type="submit" name="checkprice" value="1" class="btn btn-dark text-uppercase w-100 mt-3">Pay</button> 
                            </form>
                        </div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="row  d-flex" >
                            ...
                            <ul style="list-style: none" class=" w-100" >
                                            ...
                                            <li style="">
                                                <div style="height: 100px" class="d-flex position-relative justify-content-between p-1">
                                                    <img src="assets/img/products/P10.png" class="flex-shrink-0 me-3" alt="${y.image}">
                                                    <div class="d-flex flex-column justify-content-start">
                                                        <div>
                                                            <h5 class="mt-0">name</h5>
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div id="#quantity"  >Quantity: 20000 vnd</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-center align-items-center">
