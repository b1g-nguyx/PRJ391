<%-- Document : home Created on : Feb 27, 2024, 7:04:52 PM Author : nguye --%>
...
<html>
    <head>
        ...
        <jsp:useBean id="ci" class="dal.Shopping_Cart_ItemDAO" scope="request"></jsp:useBean>
                ...
                <div class="carousel-inner ">
                    ...
                    <c:forEach   begin="1" end="3" var="i">
                        <div class="carousel-item active">
                            <img style="width: 100%; height: 70%" src="assets/img/P${i}.png" class="d-block  img-fluid" alt="${i}">
                        </div>
                    </c:forEach>
                </div>
        ...
        <div class="container">
            <h1 class="m-5 d-flex justify-content-center">Best seller</h1>
            <div class="row d-flex justify-content-evenly">
                <c:set var="count" value="1"/>    
                <c:forEach  var="y" items="${ci.top}">
                    <c:if test="${count <10}">
                        <c:set var="count" value="${count+1}"/>
                        <c:forEach var="i" items="${p.all}">
                            <c:if test="${y.product_id == i.id}">
                                <div class="col-auto d-flex justify-content-center pb-4">
                                    <div class="card shadow " style="width: 18rem;">
                                        <c:set var="pcc" value="${pc.getCategory(i.category_id).getName()}"/>
                                        <a href="/Project_of_assignment/detail?p=${i.id}&&pc=${pcc}" style="" class="disabled text-dark text-decoration-none link-underline-opacity-0" id="moreinformation">
                                            <img src="assets/img/products/${i.image}" class="card-img-top shadow img-thumbnail" alt="${i.image}">
                                            <div class="card-body">
                                                <h5 class="card-title">${i.name}</h5>
                                                <p class="card-text">${i.descriotion}</p>
                                                <p class="ps-2 card-text text-secondary">${i.price} VND</p>
                                            </div>
                                        </a>
        ...
        <!<!-- about -->
        <div class="container-fluid mt-5  pb-5" id="about" style="background-color: pink; opacity: .8;">
            <div class="container">
                <h1  class="pt-5 pb-3 fs-1 d-flex justify-content-center">About me</h1>
                <p class="text-break  h-100 mb-0" style="text-align: justify;">Chúng tôi tự hào là một trong những trang web hàng đầu về trang sức trực tuyến. Phương châm của chúng tôi là “Cuộc sống phải rực rỡ, quyến rũ“. Hãy tận hưởng nó, bạn chính là người đẹp nhất!

                    Store by Heart được thành lập với sứ mệnh mang lại phong cách và đẳng cấp cho cuộc sống của bạn bởi những món trang sức tuyệt đẹp. Chúng tôi tin rằng trang sức không chỉ là phụ kiện mà còn là một cách để bạn thể hiện bản thân, kể những câu chuyện, gửi gắm hy vọng, lời chúc ý nghĩa đến người thân, bạn bè, đồng nghiệp mà mình yêu mến. Store by Heart luôn nắm bắt tốt “thời trang” và “sự độc đáo“ trong nhiều dịp lễ, ngày kỹ niệm khác nhau. Chính vì vậy chúng tôi tự tin là nơi bạn có thể chọn lựa được những món trang sức làm nổi bật cá tính và phong cách riêng của bạn.</p>
            </div>
        </div>
